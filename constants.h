...
const int steps = 200; //amount of timesteps that will be run
const float domainSize = 0.5; //size of the simulation domain
const float minFeatureSize = 5e-1; //5mm, minimum physical feature size we can resolve
...
const float dt = minTau / (timeStepsPerPulse); //amount of time that passes between timesteps
